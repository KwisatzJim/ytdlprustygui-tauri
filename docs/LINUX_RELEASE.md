...
Status: the x86-64 AppImage has been built on Ubuntu and manually tested successfully. The Ubuntu-server build verified copyright notices for all 178 bundled ELF libraries with 0 unresolved libraries. Version 0.2.2 is published on GitHub. Future Linux candidates are built on the project's Ubuntu server.
